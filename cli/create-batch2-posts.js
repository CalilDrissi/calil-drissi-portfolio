...
const enPosts = [
  ...require('./content-dbdesign-en.js'), ...require('./content-vectordb-en.js'), ...require('./content-backendscale-en.js'),
  ...require('./content-godot-en.js'), ...require('./content-vr-en.js'),
];
const frPosts = [
  ...require('./content-dbdesign-fr.js'), ...require('./content-vectordb-fr.js'), ...require('./content-backendscale-fr.js'),
  ...require('./content-godot-fr.js'), ...require('./content-vr-fr.js'),
];
